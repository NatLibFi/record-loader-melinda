...
(function (root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        define(['record-loader-marc/lib/result-formatters/marc'], factory);
    } else if (typeof module === 'object' && module.exports) {
        module.exports = factory(require('record-loader-marc/lib/result-formatters/marc'));
    }
...
function factory(protoFactory)
{
	...
	proto.data = function(record)
	{
	    return fn_proto_data(record.record);
	};
