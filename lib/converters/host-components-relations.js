...
(function (root, factory) {
  ...
  if (typeof define === 'function' && define.amd) {
    define(['es6-polyfills/lib/polyfills/promise', 'marc-record-js', 'record-loader-prototypes/lib/converters/prototype'],factory);
  } else if (typeof module === 'object' && module.exports) {
    module.exports = factory(require('es6-polyfills/lib/polyfills/promise'), require('marc-record-js'), require('record-loader-prototypes/lib/converters/prototype'));
  }
...
function factory(Promise, MarcRecord, protoFactory) {
  ...
  return function()
  {
    ...
    proto.convert = function(record)
    {
      if (record.hasOwnProperty('record') && isCloneOf(record.record, new MarcRecord())) {
        return {
