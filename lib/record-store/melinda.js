...
function factory(Promise, Object, MarcRecord, jjv, jjve, jxon, MelindaClient, createSruClient, AlephX, marc_record_converters, schema)
{
	...
	function getMelindaRecords(id_list, get_components, records)
	{
	    ...
	    var fn_load_record = get_components ? melinda_client.loadChildRecords : melinda_client.loadRecord,
	    id = id_list.shift(),
		...
		return fn_load_record.call(melinda_client, id, client_params).then(function(result) {
	...
	return {
	    ...
	    'read': function(query, get_components)
	    {
