...
(function (root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        define(['es6-polyfills/lib/promise', 'mimemessage', 'marc-record-js', 'marc-record-converters', 'record-loader-prototypes/lib/record-set/prototype'], factory);
    } else if (typeof module === 'object' && module.exports) {
        module.exports = factory(require('es6-polyfills/lib/promise'), require('mimemessage'), require('marc-record-js'), require('marc-record-converters'), require('record-loader-prototypes/lib/record-set/prototype'));
    }
