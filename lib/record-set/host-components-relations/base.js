...
(function (root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        define(['es6-polyfills/lib/promise', 'mimemessage', 'marc-record-js', 'marc-record-converters'], factory);
    } else if (typeof module === 'object' && module.exports) {
        module.exports = factory(require('es6-polyfills/lib/promise'), require('mimemessage'), require('marc-record-js'), require('marc-record-converters'));
    }

}(this, factory));

function factory(Promise, mimemessage, MarcRecord, marc_record_converters) {
	...
	return function(parameters) {
	    ...
	    return {
		initialise: function(input_data, find_related_records_arg)
		{
