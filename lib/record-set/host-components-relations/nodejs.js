...
(function (root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        define(['es6-polyfills/lib/promise', 'fs', 'stream', './base'], factory);
    } else if (typeof module === 'object' && module.exports) {
        module.exports = factory(require('es6-polyfills/lib/promise'), require('fs'), require('stream'), require('./base'));
    }
