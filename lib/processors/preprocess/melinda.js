...
function factory(Promise, Object, MarcRecord, validateFactory, processorFactory) {
  ...
  return function(parameters) {
    var logger,
    fn_validate = typeof parameters === 'object' && Array.isArray(parameters.validators) ? validateFactory(Object.assign(JSON.parse(JSON.stringify(parameters)), {
      fix: true,
      failOnError: true
    })) : undefined,
    ...
    return Object.assign(obj, {
      ...
      run: function(record)
      {
        ...
        return fn_validate ? fn_validate(record).then(function(result) {
