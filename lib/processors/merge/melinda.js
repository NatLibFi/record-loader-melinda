...
(function (root, factory) {
  ...
  if (typeof define === 'function' && define.amd) {
    ...
    module.exports = factory(
      ...
      require('@natlibfi/marc-record-validators-melinda'),
      require('marc-record-js'),
      require('@natlibfi/marc-record-rank/lib/rank'),
      require('@natlibfi/marc-record-merge'),
        ...
        if (matched_records.length > 1) {
          ...
          return (fn_validate ? fn_validate(result.record) : Promise.resolve()).then(function() {
            if (arguments[0] !== undefined) {
              ...
              return result.mergeDetails.validate.failed ? /* istanbul ignore next: Cannot be reasonable tested, because only certain validators return errors */ Promise.reject(result) : result;
