...
(function (root, factory) {
	...
	define(['chai', 'chai-as-promised', '../lib/processors/match/host-components-relations'], factory);
    } else if (typeof module === 'object' && module.exports) {
        module.exports = factory(require('chai'), require('chai-as-promised'), require('../lib/processors/match/host-components-relations'));
    }
...
function factory(chai, chaiAsPromised, match)
{
    ...
    describe('processor-match-host-components-relations', function() {
